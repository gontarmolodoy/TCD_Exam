...
class PlayerWindow(Toplevel):
    def __init__(self, content, content_avg, content3, name, a, b, c, base = None):
        ...
        #Фотография игрока
        ebuchka = Image.open(content3)
        ebuchka = ebuchka.resize((150, 150))
        new_ebuchka = ImageTk.PhotoImage(ebuchka)
        self.photo = Label(self, image=new_ebuchka)
        self.photo.image = new_ebuchka
...
btn.bind("<Button>", lambda e: PlayerWindow('images/Panarintotal.png', 'images/Panarinaverage.png', 'images/Panarin.png','Артемий Панарин', 1.11, 0.45, 0.66))
btn.pack(pady=10)

#Кнопка для Фокса
btn1 = Button(base, text='Адам Фокс')
btn1.bind("<Button>", lambda e: PlayerWindow('images/Foxtotal.png', 'images/Foxaverage.png','images/Fox.png' ,'Адам Фокс', 0.77, 0.05, 0.72))
btn1.pack(pady=10)

#Кнопка для Фокса
btn2 = Button(base, text='Винсент Трочек')
btn2.bind("<Button>", lambda e: PlayerWindow('images/Trochektotal.png', 'images/Trochekaverage.png','images/Trochek.png' ,'Винсент Трочек', 0.65, 0.31, 0.34))
btn2.pack(pady=10)

#Кнопка для Зибанежада
btn3 = Button(base, text='Мика Зибанежад')
btn3.bind("<Button>", lambda e: PlayerWindow('images/Zibatotal.png', 'images/Zibaaverage.png', 'images/Ziba.png' ,'Мика Зибанежад', 0.61, 0.18, 0.43))
btn3.pack(pady=10)

#Кнопка для Лафика
btn4 = Button(base, text='Алексис Лафренье')
btn4.bind("<Button>", lambda e: PlayerWindow('images/Lafitotal.png', 'images/Lafiaverage.png', 'images/Lafi.png','Алексис Лафренье', 0.56, 0.25, 0.31))
btn4.pack(pady=10)

#Кнопка для Кайлле
btn5 = Button(base, text='Уилл Кайлле')
btn5.bind("<Button>", lambda e: PlayerWindow('images/Cullyetotal.png', 'images/Cullyeaverage.png', 'images/Cuylle.png','Уилл Кайлле', 0.54, 0.25, 0.29))
btn5.pack(pady=10)
